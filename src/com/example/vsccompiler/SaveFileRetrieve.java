...
public class SaveFileRetrieve extends AsyncTask<Void, Long, Boolean>{
	...
	public SaveFileRetrieve(Context context, DropboxAPI<?> api,
       ...
       //     int y = (int)(Math.random()*10000);
           ...
           // {
            ...
            try {
                ...
                outputStream = new FileOutputStream(file);
                mApi.getFile(path, null, outputStream, null);
            } catch (DropboxException e) {
                Log.e("DbExampleLog", "Something went wrong while downloading.");
            } catch (FileNotFoundException e) {
                Log.e("DbExampleLog", "File not found.");
            ...
            setmDrawable(Drawable.createFromPath(cachePath));
...
//			StringBuffer stringBuffer = new StringBuffer();
        	...
        	{}
        	Toast error = Toast.makeText(mContext, "File Downloaded Successfully", Toast.LENGTH_LONG);
	        error.show();
           
        } else{
        	Toast error = Toast.makeText(mContext, "File Downloaded UnSuccessfully", Toast.LENGTH_LONG);
	        error.show();
        }
    }
